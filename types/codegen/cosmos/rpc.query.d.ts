export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    cosmos: {
        ...
        group: {
            v1: {
                groupInfo(request: import("./group/v1/query").QueryGroupInfoRequest): Promise<import("./group/v1/query").QueryGroupInfoResponseSDKType>;
                groupPolicyInfo(request: import("./group/v1/query").QueryGroupPolicyInfoRequest): Promise<import("./group/v1/query").QueryGroupPolicyInfoResponseSDKType>;
                groupMembers(request: import("./group/v1/query").QueryGroupMembersRequest): Promise<import("./group/v1/query").QueryGroupMembersResponseSDKType>;
                groupsByAdmin(request: import("./group/v1/query").QueryGroupsByAdminRequest): Promise<import("./group/v1/query").QueryGroupsByAdminResponseSDKType>;
                groupPoliciesByGroup(request: import("./group/v1/query").QueryGroupPoliciesByGroupRequest): Promise<import("./group/v1/query").QueryGroupPoliciesByGroupResponseSDKType>;
                groupPoliciesByAdmin(request: import("./group/v1/query").QueryGroupPoliciesByAdminRequest): Promise<import("./group/v1/query").QueryGroupPoliciesByAdminResponseSDKType>;
                proposal(request: import("./group/v1/query").QueryProposalRequest): Promise<import("./group/v1/query").QueryProposalResponseSDKType>;
                proposalsByGroupPolicy(request: import("./group/v1/query").QueryProposalsByGroupPolicyRequest): Promise<import("./group/v1/query").QueryProposalsByGroupPolicyResponseSDKType>;
                voteByProposalVoter(request: import("./group/v1/query").QueryVoteByProposalVoterRequest): Promise<import("./group/v1/query").QueryVoteByProposalVoterResponseSDKType>;
                votesByProposal(request: import("./group/v1/query").QueryVotesByProposalRequest): Promise<import("./group/v1/query").QueryVotesByProposalResponseSDKType>;
                votesByVoter(request: import("./group/v1/query").QueryVotesByVoterRequest): Promise<import("./group/v1/query").QueryVotesByVoterResponseSDKType>;
                groupsByMember(request: import("./group/v1/query").QueryGroupsByMemberRequest): Promise<import("./group/v1/query").QueryGroupsByMemberResponseSDKType>;
                tallyResult(request: import("./group/v1/query").QueryTallyResultRequest): Promise<import("./group/v1/query").QueryTallyResultResponseSDKType>;
            };
        };
        mint: {
            v1beta1: {
