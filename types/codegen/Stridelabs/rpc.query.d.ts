export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    stridelabs: {
        stride: {
            icacallbacks: {
                params(request?: import("../icacallbacks/query").QueryParamsRequest): Promise<import("../icacallbacks/query").QueryParamsResponseSDKType>;
                callbackData(request: import("../icacallbacks/query").QueryGetCallbackDataRequest): Promise<import("../icacallbacks/query").QueryGetCallbackDataResponseSDKType>;
                callbackDataAll(request?: import("../icacallbacks/query").QueryAllCallbackDataRequest): Promise<import("../icacallbacks/query").QueryAllCallbackDataResponseSDKType>;
            };
        };
    };
}>;
